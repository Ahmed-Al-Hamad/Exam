...
INSERT INTO users(users,users,users,users) VALUES(v1,v2,v3,v4)

Q8) What is the query to update the `name` of a user that has `info@meraki-academy.org` as an email?
'UPDATE users SET name = ahmad WHERE email =info@meraki-academy.org ;
